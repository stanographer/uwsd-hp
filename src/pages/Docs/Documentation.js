          ...
          <Container>
            <Row>
              <Col>
                ...
                <code className="text-success rounded p-2 bg-dark font-weight-bold">
                  import './Apps.scss';
                </code>
                <br />
                <br />
                ...
                <p className="text-muted">
                  ...
                  version is greater then 9. You can simply switch your current
                ...
                <p className="text-muted">
                  Reactstrap provides prebuilt Bootstrap 4 components that allow
                ...
                <div className="mt-4 p-4 bg-light rounded shadow">
                  <p className="mb-0 text-muted">
                    ...
                    <code className="font-weight-bold">style.scss</code> to{" "}
                    <code className="font-weight-bold">style-rtl.scss</code>
                  </p>
                </div>
