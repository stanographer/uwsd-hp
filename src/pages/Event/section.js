...
class Section extends Component {
    render() {
        return (
            <React.Fragment>
                <Parallax
                    bgImage={require("../../images/event/event.jpg")}
                    bgImageAlt="Image"
                    strength={300}
                >
                                ...
                                <Row className="justify-content-center">
                                    <Col lg="10" className="text-center">
                                        <div className="title-heading">
                                            ...
                                            <h1 className="display-4 title-dark text-white font-weight-bold mb-3">Digital Conference 2020-21</h1>
                                            <p className="para-desc title-dark mx-auto text-light">Launch your campaign and benefit from our expertise on designing and managing conversion centered bootstrap4 html page.</p>
