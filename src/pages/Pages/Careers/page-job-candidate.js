                ...
                <div className="job-profile position-relative">
                  <div className="rounded shadow bg-white">
                    <div className="text-center py-5 border-bottom rounded-top">
                      <img
                        src={profile}
                        className="avatar avatar-medium mx-auto rounded-pill shadow d-block"
                        alt="profile"
                      />
                    ...
                    <div className="p-4">
                      ...
                      <ul className="list-unstyled feature-list">
                        <li className="h5">
                          <i className="mdi mdi-email mdi-18px text-warning mr-2"></i>
                          <span className="text-muted">Email :</span>{" "}
                          thomas@mail.com
                        </li>
                        <li className="h5">
                          <i className="mdi mdi-baby mdi-18px text-warning mr-2"></i>
                          <span className="text-muted">D.O.B. :</span> 31st Dec,
                          1996
                        </li>
                        <li className="h5">
                          <i className="mdi mdi-map-marker mdi-18px text-warning mr-2"></i>
                          <span className="text-muted">Address :</span> 15 Razy
                          street
                        </li>
                        <li className="h5">
                          <i className="mdi mdi-city mdi-18px text-warning mr-2"></i>
                          <span className="text-muted">City :</span> London
                        </li>
                        <li className="h5">
                          <i className="mdi mdi-earth mdi-18px text-warning mr-2"></i>
                          <span className="text-muted">Country :</span> UK
                        </li>
                        <li className="h5">
                          <i className="mdi mdi-qrcode mdi-18px text-warning mr-2"></i>
                          <span className="text-muted">Postal Code :</span>{" "}
                          521452
                        </li>
                        <li className="h5">
                          <i className="mdi mdi-phone mdi-18px text-warning mr-2"></i>
              ...
              <Col lg="8" md="7" xs="12" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="ml-lg-4">
                  ...
                  <div className="progress-box mt-4">
                    ...
                    <div className="progress-value d-block text-muted h6 text-right">
                      84%
                    </div>
                    <Progress value="84" />
                  </div>
                  ...
                  <div className="progress-box mt-4">
                    ...
                    <div className="progress-value d-block text-muted h6 text-right progressbar-value">
                      95%
                    </div>
                    <Progress value="95" />
                  </div>
                    ...
                    {this.state.experiences.map((exp, key) => (
                      <Col key={key} lg="12" className="mt-4 pt-2">
                        <div className="company-logo text-muted h6 mr-md-4 mt-md-2 float-left text-center">
                          <img
                            src={exp.image}
                            className="avatar avatar-md-sm d-block mb-2"
                            alt="experience"
                          />
                          {exp.duration}
                        </div>
