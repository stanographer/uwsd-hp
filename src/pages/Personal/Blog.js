...
class Blog extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            blogs : [
                { id : 1, image : personal01, title : "Design your apps in your own way", like : "33", comment : "08", autor : "Calvin Carlo", date : "13th August, 2019" },
                { id : 2, image : personal02, title : "How apps is changing the IT world", like : "33", comment : "08", autor : "Calvin Carlo", date : "13th August, 2019" },
                { id : 3, image : personal03, title : "Smartest Applications for Business", like : "33", comment : "08", autor : "Calvin Carlo", date : "13th August, 2019" },
            ],
        ...
        return (
            <React.Fragment>
                <section className="section">
                    <Container>
                        {/* section title */}
                        <SectionTitle isLeft={true} title="Latest News" desc=" that can provide everything you need to generate awareness, drive traffic, connect." />
                    ...
                    <Container className="mt-100 mt-60" id="contact">
                        {/* section title */}
                        <SectionTitle isLeft={true} title="Contact Me" desc=" that can provide everything you need to generate awareness, drive traffic, connect." />
