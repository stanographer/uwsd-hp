...
// import images
import img2 from '../../images/app/classic02.png';
import img3 from '../../images/app/classic03.png';
import img4 from '../../images/app/classic04.png';
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <Container className="mt-100 mt-60">
                    <Row className="align-items-center">
                        <Col lg="6" md={{size:7, order:1}} xs={{order:2}} className="mt-5 mt-sm-0">
                            <div className="section-title">
                    ...
                    <Row className="align-items-center">
                        ...
                        <Col lg="6" md="7" className="mt-5 mt-sm-0">
                            ...
                            <SectionTitleLeft
                                ...
                                <div className="mt-4">
                                    <Link to="#" className="btn btn-primary">Read More <i className="mdi mdi-chevron-right"></i></Link>
                                </div>
                            </div>
                        </Col>
                    </Row>
